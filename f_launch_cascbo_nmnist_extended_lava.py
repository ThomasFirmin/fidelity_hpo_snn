...
parser.add_argument("--save", type=str, default="test_casbo_nmnist_ext")
...
model = Objective(
    ...
    beta_test=0.03,
    gpu=gpu,
    early_stopping=NonSpikingPercentageStopping("outpt", 5, 0.03),
    weight_norm=True,
    optimizer="SGD",
    max_epochs=20,
)
...
# Decision variables
values = get_mnist_rate_lava_cnt_extended()
...
exp = Experiment(bo, loss, stop, save="test_casbo_nmnist_ext")
exp.run()
