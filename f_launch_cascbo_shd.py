...
parser.add_argument("--save", type=str, default="test_casbo_shd")
...
model = Objective(
    ...
    beta_test=0.1,
    gpu=gpu,
    early_stopping=NonSpikingPercentageStopping("outpt", 5, 0.1),
    weight_norm=True,
    optimizer="ADAM",
    max_epochs=35,
)
...
exp = Experiment(bo, loss, stop, save="test_casbo_shd")
exp.run()
